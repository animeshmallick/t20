<div class="title-container">
    ...
    <div style="padding-top: 0.5rem; font-size: 1rem">
        <span>Balance: </span>
        <span style="font-size: 1.4rem" id="balance">0</span>
    </div>
    <?php } ?>
</div>

<nav class="w3-sidebar w3-bar-block w3-animate-left w3-top" style="font-size: 1rem;z-index:3;width:75%;display:none;left:0;margin: 0;padding: 0; background-image: url('../images/stadium3.png')" id="side-bar-container">
