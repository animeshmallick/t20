        ...
        <body onload="fill_header();
            ...
            <div class="play-container" style="margin: 0; padding: 0">
                ...
                <div class="bid_container">
                    ...
                    <div class="bid_button_div" style="margin-left: 10%; width: 80%"><a class="play bid_button <?php if($scorecard->is_live == false || (int)$scorecard->over_id > 218){echo "disabled";}?>" href="place_bid.php?session=winner">Who will win the match?</a></div>
                </div>
                <div class="separator"></div>
